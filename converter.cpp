...
int main(){
	...
	for(int i=1, numFiles=filePaths.size(); i<numFiles; i++){
		std::string systemString = "C:\\inetpub\\mascot\\perl64\\bin\\perl.exe export_dat_2.pl _ignoreionsscorebelow=0.1 _minpeplen=0 _server_mudpit_switch=99999999 _showsubsets=1 _sigthreshold=1 do_export=1 export_format=mzIdentML file=";
